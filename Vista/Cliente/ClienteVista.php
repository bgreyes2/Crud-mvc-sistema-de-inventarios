<!DOCTYPE html>
   ...
   <body>
       <a href="Controlador/ConsultaCateP.php">Agregar cliente</a>
       <table width="1016" border="1">
           ...
           <tr>
               ...
               <td><a href="Controlador/EliminarPControlador.php?id=<?php echo $fila['idcliente']; ?>">Eliminar</a></td>
               <td><a href="Controlador/ActualizarPModificar.php?idproducto=<?php echo $fila['idcliente']; ?>">Modificar</a></td>
           </tr>
       <?php
            }
        ?>
